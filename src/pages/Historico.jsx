...
import { PacientesContext } from "../components/PacientesContext/PacientesContext";
...
const Historico = () => {
    ...
    return (
        <Box sx={{ mt: 1, px: 2 }}>
            ...
            <FormControl fullWidth sx={{ maxWidth: 300, margin: "auto", mb: 2 }}>
            ...
            {registroEditado && (
                <Dialog open={modalOpen} onClose={handleCloseModal} fullWidth='lg'>
                    ...
                    <DialogContent sx={{ display: "flex", flexDirection: "column", gap: 2, padding: 2 }}>
                        <TextField sx={{marginTop: '10px'}} multiline rows={4} maxRows={10} fullWidth label="Situação" name="situacao" value={registroEditado.situacao} onChange={handleChange} />
                        <TextField sx={{marginTop: '10px'}} multiline rows={4} maxRows={10} fullWidth label="Background" name="background" value={registroEditado.background} onChange={handleChange} />
                        <TextField sx={{marginTop: '10px'}} multiline rows={4} maxRows={10} fullWidth label="Avaliação" name="avaliacao" value={registroEditado.avaliacao} onChange={handleChange} />
                        <TextField sx={{marginTop: '10px'}} multiline rows={4} maxRows={10} fullWidth label="Recomendação" name="recomendacao" value={registroEditado.recomendacao} onChange={handleChange} />
                    </DialogContent>
                    <DialogActions>
